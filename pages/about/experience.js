...
`,
        ...
        'pages/about/Coursework.js': {
          js: require('docs/src/pages/about/Coursework').default,
          raw: preval`
module.exports = require('fs')
  .readFileSync(require.resolve('docs/src/pages/about/Coursework'), 'utf8')
`,
        },
        'pages/about/CourseworkInd.js': {
          js: require('docs/src/pages/about/CourseworkInd').default,
          raw: preval`
module.exports = require('fs')
  .readFileSync(require.resolve('docs/src/pages/about/CourseworkInd'), 'utf8')
`,
        },
      }}
    />
